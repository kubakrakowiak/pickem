                ...
                <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="mt-8 bg-gray-800 dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div className="p-6 border-t border-gray-700 dark:border-gray-700 md:border-l">
                                <div className="flex items-center">
                                    <svg
                                        fill="none"
                                        stroke="currentColor"
                                    ...
                                    <div className="ml-4 text-lg leading-7 font-semibold text-white dark:text-white">
                                        Vibrant Ecosystem
                                    </div>
                                </div>
                    ...
                    <div className="flex justify-center mt-4 sm:items-center sm:justify-between">
                        <div className="text-center text-sm text-gray-500 sm:text-left">
                            <div className="flex items-center">
                                <a href="https://www.interligent.com" className="ml-1 underline">
                                    Interligent
                                </a>
                            </div>
                        </div>
